...
@php
    ...
    $buttonClasses = \Illuminate\Support\Arr::toCssClasses([
        ...
        match ($color) {
            'gray' => 'text-gray-700 hover:text-gray-800 focus-visible:ring-primary-900 dark:text-gray-300 dark:hover:text-gray-200 dark:focus-visible:ring-primary-300',
            default => 'fi-color-custom text-custom-800 hover:text-custom-900 focus-visible:ring-custom-900 dark:text-custom-200 dark:hover:text-custom-100 dark:focus-visible:ring-custom-300',
        },
